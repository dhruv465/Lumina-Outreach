...
/**
 * WebCallDiagnosticPanel Component
 * 
 * Displays diagnostic information and monitoring data for web call testing
 */
const WebCallDiagnosticPanel: React.FC<DiagnosticPanelProps> = ({ socket, isConnected, className = '' }) => {
...
export default WebCallDiagnosticPanel;